...
def main():
    ...
    enc = Encoder(in_ch=32)
    dec = Decoder(out_ch=3)
    dis = Discriminator(in_ch=32, out_ch=3)
    ...
    train_d = facade_dataset.DecompDataset(args.dataset, data_range=(1,30))
    test_d = facade_dataset.DecompDataset(args.dataset, data_range=(30,40))
